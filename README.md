# Online Retail Revenue Drivers & Customer Purchasing Behaviour
...
- What business actions should be taken based on these findings?



## Dataset

The analysis was performed using an online retail transaction dataset containing customer purchases, product descriptions, invoice information, quantities, prices and customer identifiers.

> **Note:** The original dataset has been compressed due to file size limitations on GitHub.
...
- Strengthen customer loyalty programmes to encourage repeat purchases.
